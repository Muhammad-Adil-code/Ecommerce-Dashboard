                ...
                <div className="media">
                  ...
                  <div className="media-body">
                    <h5 className="mb-sm-4 mb-3">
                      <Link className="text-black" href="/ecom-product-detail">
                        {d.title}
                      </Link>
                    </h5>
                    <div className="d-flex mb-2">
                      <svg
                        className="me-2 card-ico"
                        width={15}
                        height={15}
                        viewBox="0 0 15 15"
                        fill="none"
                      ...
                      <span className="fs-14 text-black">
                        <strong className="me-1">{d.totalSells}</strong> Total
                        Sales
                      </span>
                    </div>
        ...
        <div className="row">
          <div className="col-xl-12 col-xxl-6 col-md-6">
            <div className="card trending-menus">
              ...
              {analyticsData && (
                <div
                  className="card-body pt-0 height550 dz-scroll"
                  id="tredingMenus"
                >
                  {analyticsData &&
                    analyticsData.trendingMenus.data.map((data, i) => (
                      <div
                        key={i}
                        className={`d-flex pb-3 mb-3 tr-row align-items-center ${analyticsData &&
                      ...
                      >
                        ...
                        <div className="me-auto pe-3">
                          <Link href="/post-details" passHref>
                          ...
                          <span className="fs-14">Sales: {data.order} units</span>
                        </div>
                        <Image src={data.img} alt="Picture of the author" height={60} width={60} />
                      </div>
                    ))}
                </div>
              )}
              ...
              <div className="card-header border-0">
                ...
                <div className="me-auto">
                  ...
                  <p className="fs-14 mb-0">
                    Your highest performing products this month
                  </p>
                </div>
              </div>
              {analyticsData && (
                ...
                >
                  {analyticsData &&
                    analyticsData.bestseler.data.map((d, i) => (
                      <div
                        className={`card-body border-bottom ${i == 0 && "pt-0"
            ...
            <div className="card">
              <div className="card-header border-0">
                ...
                <div className="me-auto">
                  ...
                  <p className="fs-14 mb-0">
                    Customers with the highest repeat purchase rate
                  </p>
                </div>
              </div>
              {analyticsData && (
                      ...
                      <div className="media align-items-center mb-4" key={i}>
                        ...
                        <div className="media-body">
                          <h5 className="text-black">
                            <Link href="" scroll={false} className="text-black">{d.name}
                            </Link>
                          </h5>
          ...
          <div className="col-xl-12">
            <Tab.Container defaultActiveKey="all_categories">
              <div className="card">
                    ...
                    <div className="me-auto">
                      ...
                      <p className="fs-14 mb-0">
                        {analyticsData && analyticsData.fvtItem.subHeading
                          ...
                          : "Browse your product inventory by category"}
                      </p>
                    </div>
                  </div>
                ...
                <div className="card-footer border-0 text-center pb-3 pt-0">
                  <Link href="#" scroll={true} className="btn-link">View More &gt;&gt;</Link>
                </div>
              </div>
            </Tab.Container>
                  ...
                  <div className="card-header flex-wrap border-0 pb-0">
                    <div className="mb-3 d-flex">
                      ...
                      <div className="me-auto">
                        ...
                        <p className="fs-14 mb-0">
                          {analyticsData && analyticsData.charts.revenue.subHeading
                            ? analyticsData.charts.revenue.subHeading
                            : "Total revenue growth across all regions"}
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="card-header border-0 pb-0">
                    ...
                    <div className="me-auto">
                      ...
                      <p className="fs-13 mb-0 text-black">
                        {analyticsData && analyticsData.charts.customer.subHeading
