...
const Element = ({ pageTitle }) => {
  ...
  return (
    <Fragment>
      <PageTitle_ active="Element" mother="Form" />
      <div className="row">
              ...
              <div className="basic-form">
                <form onSubmit={(e) => e.preventDefault()}>
                  <div className="mb-3 mb-0">
                    <div className="radio">
                      <label className="form-label">
                        <input type="radio" name="optradio" className="form-check-input"/> Option 1
                      </label>
                    </div>
                    <div className="radio">
                      <label className="form-label">
                        <input type="radio" name="optradio" className="form-check-input"/> Option 2
                      </label>
                    </div>
                    <div className="radio disabled">
                      <label className="form-label">
                        <input type="radio" name="optradio" disabled className="form-check-input" /> Option 3
                      </label>
                    </div>
                  </div>
                </form>
              ...
              <div className="basic-form">
                <form onSubmit={(e) => e.preventDefault()}>
                  <div className="mb-3 mb-0">
                    ...
                    <label className="radio-inline me-3">
                      <input type="radio" name="optradio" className="form-check-input" /> Option 3
                    </label>
                  </div>
                </form>
              </div>
            ...
            <div className="card-body">
              <div className="basic-form">
                <form className="form-inline">
                  ...
                  <div className="mb-3 mx-sm-3 mb-2">
              ...
              <div className="basic-form">
                <form onSubmit={(e) => e.preventDefault()}>
                  <div className="form-row align-items-center">
                    <div className="col-auto my-1" style={{ width: "100%" }}>
          ...
          <div className="card">
            ...
            <div className="card-body">
              <div className="basic-form">
                <form action="#">
                  <div className="input-group mb-3">                    
                      <label className="input-group-text mb-0 form-label">Options</label>                    
                    <select
                      defaultValue={"option"}
                      className="form-control"
                    >
