          ...
          <div className="col-xl-12 col-lg-6 col-md-6">
            <div className="card">
              ...
              <div className="card-body  text-center">
                ...
                <Link href="/apps/post-details" className="btn btn-outline-primary">More Details</Link>
              </div>
            </div>
          </div>
          <div className="col-xl-12 col-lg-6 col-md-6">
                  ...
                  >
                    {trendingMenu &&
                      trendingMenu.data.map((data, i) => (
                        <div
                          key={i}
                          className={`d-flex pb-3 mb-3 tr-row align-items-center ${trendingMenu && trendingMenu.data.length - 1 !== i
                              ? "border-bottom"
                              : ""
                            }`}
                        >
              ...
              <div className="card">
                <div className="card-header pb-0 flex-wrap border-0">
                  ...
                  <div className="d-flex mb-3">
                    <div className="custom-control custom-switch toggle-switch text-right me-4">
                      <input
                        type="checkbox"
                          ...
                          >
                            ...
                            <td>
                              <div className="d-flex align-items-center justify-content-center">
                                <h4 className="mb-0 me-3 fs-20 text-black d-inline-block">
                                  ${d.price}
                                </h4>
                            ...
                            <td>
                              <div className="d-flex align-items-center">
                                <Link href="#" scroll={false}
                                  className={`btn text-${d.statusColor}`}>
                                  {d.status}
                                </Link>
                                <Dropdown className="dropdown ms-auto">
                                  ...
                                  >
                                    ...
                                    <Link href="" className="dropdown-item text-black">
                                      View Details
                                    </Link>
                                  </Dropdown.Menu>
                                </Dropdown>
