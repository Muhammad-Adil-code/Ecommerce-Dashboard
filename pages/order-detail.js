      ...
      <div className="d-flex mb-3 mb-lg-4 align-items-center">
        <div className="me-auto d-none d-lg-block">
          <div className="d-flex flex-wrap align-items-center">
            <h3 className="text-black font-w600 mb-0 fs-22 me-5">
          ...
          <div className="row">
            <div className="col-xl-12 col-md-6">
              <div className="card">
                ...
                <div className="card-body">
                  <h4 className="text-black fw-bold mb-3 wspace-no">
                    Note Order
                  </h4>
                  <p>
                    {orderDetails &&
            ...
            <div className="col-xl-12 col-md-6">
              <div className="card">
                ...
                <div className="card-body">
                  <div className="text-center order-media">
                    <Image
                      src="/images/profile/Untitled-1.jpg" alt=""
                      height={91}
                      width={91}
                    />
                    <div>
                      <h4 className="mb-1 font-w600">
                        {orderDetails &&
                          orderDetails.profile &&
                    ...
                    <table className="table items-table table-responsive-lg">
                      <tbody>
                        <tr className="thead-primary">
                          <th className=" font-w500 fs-20">Items</th>
                          <th
                            style={{ width: "10%" }}
                            className=" font-w500 fs-20"
                          >
                            Qty
                          </th>
                          <th
                          ...
                          <th className="my-0 font-w500 fs-20 wspace-no d-md-none d-lg-table-cell">
                            Total Price
                          </th>
                          <th />
                        </tr>
                                ...
                                <div className="media">
                                  ...
                                  <div className="media-body">
                                    ...
                                    <h5 className="mt-0 mb-2 mb-4">
                                      <Link href="/apps/ecom/product-detail" className="text-black" passHref>
                                        {d.title}
                                      </Link>
                                    </h5>
